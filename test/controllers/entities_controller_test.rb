...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference("Entity.count") do
      post entities_url, params: { entity: { amount: @entity.amount, group_id: @entity.group_id, name: @entity.name, user_id: @entity.user_id } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { amount: @entity.amount, group_id: @entity.group_id, name: @entity.name, user_id: @entity.user_id } }
